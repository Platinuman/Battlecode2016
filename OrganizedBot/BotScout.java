...
public class BotScout extends Bot {
	protected static int scoutType; //NEW  0 = turret; 1 = mobilehelper, 2 = explorer etc
	/* NEW re add these if they are absolutely necessary (many will be)
...
*/
	...
	private static void init() throws GameActionException {
		...
		/*// atScoutLocation = false; NEW move this so MESSAGE ENCODE
		size = 0;
		partAndNeutralLocs = new MapLocation[10000];
		partsOrNeutrals = new int[10000];
		range = 3;*/
		/* THIS SHOULD BE IN MESSAGE ENCODE
...
*/
	private static void turn() throws GameActionException {
		...
		switch(scoutType){ // NEW should call methods in Harass
			...
			default;
			return;
		}/* This should all be moved to Harass
		if(!isMobile){
		if (rc.isCoreReady()) {
